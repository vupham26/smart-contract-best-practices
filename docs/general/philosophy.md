...
- [**Rollout carefully**.](techniques/contract_rollout.md) It is always better to catch bugs before a full production release.
  - Test contracts thoroughly, and add tests whenever new attack vectors are discovered
  - Provide [bug bounties](techniques/bounties.md) starting from alpha testnet releases
